 ...
 * @author User
 */
public class framabarang extends javax.swing.JFrame {

    /**
     * Creates new form framabarang
     */
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        try {
            ...
            String nama_suplai = txtNamaBarang.getText();
            String satuan = txtSatuan.getText();
            myObject.simpanbarang(kode_barang, kode_barang, satuan);
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        try {
            String kode_barang = txtKodeBarang.getText();
            String no_suplai = txtNamaBarang.getText();
            String harga_barang = txtSatuan.getText();
            myObject.ubahBarang(kode_barang, no_suplai, harga_barang);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(framabarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new framabarang().setVisible(true);
            }
        });
    }
